...
public interface CalculationRepository extends CrudRepository<Calculation, Long> {
	...
	@Query(value = """
		select cal.c_id, cal.c_status, cal.c_lot_name, cal.c_project_name, cal.c_project_location,
	...
	@Query(value = """
		select cal.c_id, cal.c_status, cal.c_lot_name, cal.c_project_name, cal.c_total_sum
		from data.t_calculations as cal
