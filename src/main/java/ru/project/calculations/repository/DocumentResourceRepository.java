...
public interface DocumentResourceRepository extends CrudRepository<DocumentResource, Long> {
	...
	@Query(value = """
		select docres.c_id, docres.c_doc_name, docres.c_doc_type, docres.c_key, docres.c_doc_size,
		       docres.c_doc_index, docres.c_calc_id, docres.c_content_type, c_user_id, c_time_stamp
	...
	@Query(value = """
		...
		(c_doc_name, c_doc_type, c_key, c_doc_size, c_doc_index, c_calc_id, c_content_type, c_user_id, c_time_stamp)
		values (:docName, :docType, :key, :size, :documentIndex, :calcId, '{}', :userId, :timeStamp)
		""")
