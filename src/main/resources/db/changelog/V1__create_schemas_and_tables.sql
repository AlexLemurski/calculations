...
(
    ...
    c_legal_address varchar(3000),
    c_kpp_code      varchar(20),
    c_inn_code      varchar(20)
        constraint t_customers_pk_2
            unique,
    c_ogrn_code     varchar(20)
        constraint t_customers_pk_3
            unique,
    c_main_activity varchar(500),
    c_mail          varchar(100),
    c_phone         varchar(50)
);
